...
**Last synced with migration:** `20260116183125_add_options_order_ordered_quiz_type_to_questions.sql`
...
- `options_order` (int[]) - array of the order of answer choices (if ordered is true)
- `ordered` (bool, default: false) - whether answer choices should stay ordered
- `quiz_type` (text) - type of quiz (practice, timed, etc.)
- `exam_id` → exams
- `chapter_id` → chapters
- `anatomy_id` → anatomy
